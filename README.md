...
Quick Settings Audio Panel (QSAP) is a gnome 48/49/50/51 extension that creates a new panel for sound related stuff in the quick settings.
 ...
 * Run this command: `gnome-extensions install path/to/quick-settings-audio-panel@rayzeq.github.io.shell-extension.zip --force`
